...
description: "This webhook is fired when a notarization is completed and the notarized document is ready to be downloaded"
---
...
All webhook requests include a signature in the `X-Platus-Signature` header. This signature is a HMAC SHA-256 hash of the raw request body using your webhook secret. Here's how to verify it:
