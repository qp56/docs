        ...
        "directors": [
          {
            "first_name": "Stefan",
            "last_name": "Müller",
            "email": "stefan.muller@mail.de"
          },
          {
            "first_name": "Anna",
            "last_name": "Schmidt",
            "email": "anne.schmidt@mail.de"
          }
        ],
        "shares": 12500,
        "share_percentage": 50
...
<ResponseField name="status" type="string">
  ...
  **Possible values**: `Initiated` , `Pending`, `Appointment Confirmed` or `Completed`
</ResponseField>

<ResponseField name="url" type="string">
  A unique, case-specific URL for accessing and monitoring the incorporation process.\
  **Example**: `https://app.beglaubigt.de/incorporate/450506c1-d1a7-46e2-aca6-41a816805595`
</ResponseField>
...
```json
{
  "response": {
    ...
    "status": "Pending",
    "url": "https://app.beglaubigt.de/incorporate/450506c1-d1a7-46e2-aca6-41a816805595",
    "documents": {
      "articles_of_association": [
        {
          "name": "sample.pdf",
