...
The `incorporation.initiated` event is automatically triggered once the initial incorporation details — name, legal form, and purpose — are provided and a UUID has been assigned to the process.
