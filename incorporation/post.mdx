...
<ParamField body="notarization" type="object" required>
  ...
  <Expandable title="Notarization Object">
    ...
    <ParamField body="desired_timeframe" type="number">
      The client's preferred timeframe for notarization, expressed as the number of days from the request date. **Possible values**: `7`, `14`, `30`
    </ParamField>
  </Expandable>
</ParamField>
