    ...
    <ParamField body="individuals" type="array" required="false">
      ...
      <Expandable title="Individual">
        ...
        <ParamField body="dob" type="string" required>
          The date of birth of the individual shareholder. Format: `DD.MM.YYYY`.\
          **Example**: `10.05.1985`
        </ParamField>
...
<ParamField body="directors" type="array" required>
  ...
  <Expandable title="Director">
    ...
    <ParamField body="dob" type="string" required>
      Date of birth of the director in `DD.MM.YYYY` format.\
      **Example**: `03.15.1978`
    </ParamField>
    <ParamField body="address" type="object" required>
...
<ParamField body="notarization" type="object" required>
  ...
  <Expandable title="Notarization Object">
    ...
    <ParamField body="desired_date" type="string">
      Target notarization date in `DD.MM.YYYY` format.\
      **Example**: `15.04.2025`
    </ParamField>
