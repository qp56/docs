...
<ResponseField name="legal_form" type="string">
...
<ResponseField body="notarization" type="object" required>
      ...
      **Example**: `1978-03-15`
        ...
        <ResponseField name="notary" type="object">
          ...
          <Expandable title="Notary">
            ...
            <ResponseField name="name" type="string">
              The full name of the notary, including any academic or professional titles.
            ...
            <ResponseField name="address" type="string">
              The full address of the notary's office, formatted as "street name and number,
              postal code, city".
