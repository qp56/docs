...
<ResponseField name="status" type="string">
  ...
  **Possible values**: `initiated`, `submitted`, `appointment-confirmed`, `completed`, `blocked`, `archive` or `unprocessable`
</ResponseField>
...
<ResponseField body="client_preferred_language" type="string">
  The preferred language of the client, specified using **ISO 639-1** language codes.\
  **Possible values**: `en`, `de`, `es`, `fr` or `it`
</ResponseField>
